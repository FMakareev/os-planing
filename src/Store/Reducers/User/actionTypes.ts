...
export const USER_UPDATE_LOADING_ERROR: string = '@@user/USER_UPDATE_LOADING_ERROR';
export const USER_UPDATE_LOADING_SUCCESS: string = '@@user/USER_UPDATE_LOADING_SUCCESS';

export const USER_ADD: string = '@@user/USER_ADD';

export const USER_REMOVE: string = '@@user/USER_REMOVE';
